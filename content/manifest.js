    ...
    chapters: [
      {
        ...
        topics: [
          { id: 'complexity',   title: '时间 / 空间复杂度分析',
            file: 'content/ds/01-intro/complexity.js' },
          { id: 'recurrence',   title: '递归式求解与主定理',
            file: 'content/ds/01-intro/recurrence.js' },
          { id: 'adt',          title: '抽象数据类型与存储结构',
            file: 'content/ds/01-intro/adt.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'seq-list',     title: '顺序表：插入删除与扩容',
            file: 'content/ds/02-list/seq-list.js' },
          { id: 'linked-list',  title: '单链表 / 双链表 / 循环链表',
            file: 'content/ds/02-list/linked-list.js' },
          { id: 'list-algo',    title: '链表经典算法（逆置 / 归并 / 找环 / 交点）',
            file: 'content/ds/02-list/list-algo.js' },
          { id: 'list-compare', title: '顺序存储与链式存储的选择',
            file: 'content/ds/02-list/list-compare.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'stack',        title: '栈的应用（括号匹配 / 表达式求值 / 递归转非递归）',
            file: 'content/ds/03-stack-queue/stack.js' },
          { id: 'queue',        title: '队列与循环队列的判空判满',
            file: 'content/ds/03-stack-queue/queue.js' },
          { id: 'special-matrix', title: '特殊矩阵与稀疏矩阵的压缩存储',
            file: 'content/ds/03-stack-queue/special-matrix.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'match',        title: '朴素模式匹配',
            file: 'content/ds/04-string/match.js' },
      ...
      },
      {
        ...
        topics: [
          { id: 'traversal',    title: '遍历（递归 / 非递归 / 层序）',
            file: 'content/ds/05-tree/traversal.js' },
          { id: 'properties',   title: '二叉树的性质与计数',
            file: 'content/ds/05-tree/properties.js' },
          { id: 'thread-tree',  title: '线索二叉树',
            file: 'content/ds/05-tree/thread-tree.js' },
          { id: 'bst',          title: '二叉排序树与平衡二叉树',
            file: 'content/ds/05-tree/bst.js' },
          { id: 'huffman',      title: '哈夫曼树与哈夫曼编码',
            file: 'content/ds/05-tree/huffman.js' },
          { id: 'forest',       title: '树、森林与二叉树的转换',
            file: 'content/ds/05-tree/forest.js' },
          { id: 'union-find',   title: '并查集',
            file: 'content/ds/05-tree/union-find.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'storage',      title: '存储结构与遍历（DFS / BFS）',
            file: 'content/ds/06-graph/storage.js' },
          { id: 'mst',          title: '最小生成树（Prim / Kruskal）',
            file: 'content/ds/06-graph/mst.js' },
          { id: 'shortest',     title: '最短路径（Dijkstra / Floyd / BFS）',
            file: 'content/ds/06-graph/shortest.js' },
          { id: 'topo',         title: '拓扑排序与关键路径',
            file: 'content/ds/06-graph/topo.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'binary',       title: '折半查找与判定树',
            file: 'content/ds/07-search/binary.js' },
          { id: 'btree',        title: 'B 树与 B+ 树',
            file: 'content/ds/07-search/btree.js' },
          { id: 'hash',         title: '散列表：冲突处理与查找效率',
            file: 'content/ds/07-search/hash.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'insert-swap',  title: '插入类与交换类排序',
            file: 'content/ds/08-sort/insert-swap.js' },
          { id: 'select-heap',  title: '选择类排序与堆',
            file: 'content/ds/08-sort/select-heap.js' },
          { id: 'merge-radix',  title: '归并排序与基数排序',
            file: 'content/ds/08-sort/merge-radix.js' },
          { id: 'sort-compare', title: '八大排序对比与选择',
            file: 'content/ds/08-sort/sort-compare.js' },
          { id: 'external',     title: '外部排序与败者树',
            file: 'content/ds/08-sort/external.js' },
        ],
      },
    ],
  },
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          ...
          { id: 'fsm',          title: '时序视角：CU 是一台状态机',
            file: 'content/co/05-cpu/fsm.js' },
          { id: 'multi-ctrl',   title: '多控制器的协同：握手 / 管辖 / 并行',
            file: 'content/co/05-cpu/multi-ctrl.js' },
